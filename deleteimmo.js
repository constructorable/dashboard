// Funktionen für das Löschen von Immobilien

// Globale Variable für aktuelle Löschanfrage
let currentDeleteRequest = null;

// Initialisierung des Delete-Moduls
function initializeDeleteModule() {
    setupDeleteEventListeners();
    console.log('Delete-Modul initialisiert');
}

// Event Listeners für Lösch-Funktionalität einrichten
function setupDeleteEventListeners() {
    // Bestätigungs-Modal Event Listeners
...
// Immobilie löschen (Hauptfunktion)
function deleteProperty(propertyId) {
    ...
    // Demo-Objekte können nicht gelöscht werden
    if (property.isDemo) {
...
function executeDelete() {
    ...
    try {
        ...
        if (storageSuccess) {
            ...
            // Falls das gelöschte Objekt im Modal geöffnet war, Modal schließen
            closePropertyModalIfOpen(propertyId);
            
        } else {
            // Bei Speicher-Fehler: Property wieder hinzufügen
        ...
        // Bei Fehler: Property wieder hinzufügen falls entfernt
...
// Property-Modal schließen falls es für die gelöschte Immobilie geöffnet ist
...
// Erfolgs-Nachricht für Löschung
...
// Bulk-Delete (mehrere Immobilien löschen) - für zukünftige Erweiterung
...
// Sicherheits-Check vor Löschung
function performSafetyCheck(property) {
    const warnings = [];
    
    // Check für hohen Fortschritt
    const progress = calculateProgress(property.checklist);
    if (progress > 75) {
...
// CSS-Styles für Delete-Funktionalität hinzufügen
