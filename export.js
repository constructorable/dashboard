// Export/Import-Funktionalität für Immobilienverwaltung
...
// Export-Optionen Modal anzeigen
function showExportOptionsModal() {
    ...
    // Event-Listener für Vorschau-Update
...
function closeExportModal() {
    ...
    if (modal) {
        ...
        setTimeout(() => {
            modal.remove();
            document.body.style.overflow = 'auto'; // Body-Scroll wieder aktivieren
        }, 300);
    }
}
...
// Export-Optionen aus Formular extrahieren
...
function showExportConfirmation(options) {
    ...
    showConfirmationModal(
        ...
        'Abbrechen',
        function() {
            // Modal schließen und Export ausführen
            closeExportModal();
...
function executeExport(options) {
    ...
    setTimeout(() => {
        ...
        if (result.success) {
            // Optional: Export-Log erstellen
            logExportActivity(result.stats);
        }
    }, 800); // Etwas längere Verzögerung für bessere UX
}

// Export-Progress anzeigen
...
function logExportActivity(stats) {
    try {
        ...
        // In Settings oder separatem Log speichern
        ...
        // Nur letzte 10 Exports behalten
...
// Event-Listener für den vorhandenen Export-Button
...
function initializeExportFunctionality() {
    ...
    // Event-Listener für vorhandenen Button hinzufügen
    // Mit mehreren Versuchen, falls Button noch nicht geladen
    let attempts = 0;
...
// CSS für Bestätigungsmodal hinzufügen
